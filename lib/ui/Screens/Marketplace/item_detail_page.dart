      ...
      child: Scaffold(
                                                    ...
                                                    children: [
                                                      ...
                                                      BlocListener<CartBloc,
                                                        ...
                                                        child:
                                                          ...
                                                          onPressed: () {
                                                            debugPrint(
                                                                'id: ${currentState.itemData.id}');
                                                            CartProductModel model = CartProductModel(
                                                                productID: currentState.itemData.id,
                                                                amount: count,
                                                                priority: "low");
                                                            Navigator.pushNamed(context, '/checkout', arguments: {"cartList":[model]});
                                                          },
                                                          buttonText:
                                                              'Buy Now',
                                                          isDisabled:
          ...
          body: SingleChildScrollView(
            child: BlocConsumer<ItemDetailBloc, ItemDetailState>(
              bloc: itemDetailBloc,
              listener: (context, state) {
                if (state is ItemDetailFetchedSuccess) {
                  // itemDetailBloc.add(ItemDetailFetchedSuccess());
                }
              },
              builder: (context, state) {
                switch (state.runtimeType) {
                            ...
                            leading: GestureDetector(
                              ...
                              child: CircleAvatar(
                                backgroundImage: (currentState
                                    ...
                                    : Image.asset(
                                            'assets/images/profilepic-anonymous.jpg')
                                        .image,
                              ),
                            ),
                            title: Text(
                                currentState.sellerData.shopName ?? "no shop"),
                            subtitle: Text(currentState.userData.username ??
                                "no username"),
                          ),
                          Row(
                            children: [
